...
{
    internal sealed class DeactivateIntegrationCommandHandler : TransactionalCommandHandler<DeactivateIntegrationCommand>
    {
        private readonly IWorkspaceRepository _workspaceRepository;
        private readonly IIntegrationRepository _integrationRepository;

        public DeactivateIntegrationCommandHandler(
        ...
        protected override async Task<IResult> ExecuteInTransactionAsync(
            DeactivateIntegrationCommand command,
